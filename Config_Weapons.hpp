...
class WeaponShops {
 ...
 class mormont {
	...
	class pmclvl4 {
		...
		level[] = { "", "", -1, "" };
		items[] = {
			{ "UK3CB_BAF_L110A3", "", 130000, -1 },
			{ "CUP_hgun_Phantom", "", 18000, -1 },
			{ "UK3CB_BAF_L115A3", "", 180000, -1 },
			{ "arifle_AK12_F", "", 90000, -1 },	
			{ "CUP_launch_M72A6_Special", "", 60000, -1 }
		};
		mags[] = {
			{ "UK3CB_BAF_338_5Rnd", "", 250 },
			{ "CUP_18Rnd_9x19_Phantom", "", 250 },			
	...
	class pmclvl1 {
		...
		level[] = { "", "", -1, "" };
		items[] = {
			{ "UK3CB_BAF_L91A1", "", 150000, -1 },
			{ "CUP_hgun_Phantom", "", 18000, -1 },
			{ "UK3CB_BAF_L119A1_FG", "", 80000, -1 }
			
		};
		mags[] = {
			{ "CUP_18Rnd_9x19_Phantom", "", 250 },
			{ "UK3CB_BAF_556_30Rnd", "", 250 },
			{ "UK3CB_BAF_556_30Rnd", "", 200, -1 }
		};
		accs[] = {
		};
	};
	...
	class genstore_pmclvl4 {
		name = "Takistan PMC General Store";
		side = "civ";
		license = "lvl1";
		level[] = { "", "", -1, "" };
		items[] = {
	...
	class cop_colonel {
		...
		items[] = {
			...
			{ "srifle_DMR_03_khaki_F", "", 10000, 50 },
			{ "srifle_DMR_03_tan_F", "", 10000, 50 },
			{ "CUP_srifle_SVD", "", 10000, 50 }
